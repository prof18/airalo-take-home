...
@Factory
internal class CountryPackagesRepositoryImpl(
    private val countryPackagesRemoteDataSource: CountryPackagesRemoteDataSource,
) : CountryPackagesRepository {
    override suspend fun getCountryPackages(countryId: CountryId): DataResult<CountryPackages> =
